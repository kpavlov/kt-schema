...
class SourceCodeGeneratorHelpersTest {
    ...
    fun `buildKClassExtensions generates code with public visibility`() {
        ...
        val context =
            CodeGenerationContext(
                options = mapOf("me.kpavlov.kt.schema.visibility" to "public"),
                parameters = emptyMap(),
                logger = mockLogger,
            )
    ...
    fun `buildKClassExtensions generates code with internal visibility`() {
        ...
        val context =
            CodeGenerationContext(
                options = mapOf("me.kpavlov.kt.schema.visibility" to "internal"),
                parameters = emptyMap(),
                logger = mockLogger,
            )
    ...
    fun `buildKClassExtensions generates code with private visibility`() {
        ...
        val context =
            CodeGenerationContext(
                options = mapOf("me.kpavlov.kt.schema.visibility" to "private"),
                parameters = emptyMap(),
                logger = mockLogger,
            )
    ...
    fun `buildKClassExtensions generates code with no visibility modifier`() {
        ...
        val context =
            CodeGenerationContext(
                options = mapOf("me.kpavlov.kt.schema.visibility" to ""),
                parameters = emptyMap(),
                logger = mockLogger,
            )
    ...
    fun `buildKClassExtensions includes visibility in both string and object functions`() {
        ...
        val context =
            CodeGenerationContext(
                options =
                    mapOf(
                        "me.kpavlov.kt.schema.visibility" to "internal",
