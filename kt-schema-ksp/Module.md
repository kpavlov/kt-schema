...
- `kt.schema.rootPackage` - filter generation to specific package
- `kt.schema.withSchemaObject` - generate typed json schema object as extension property
- `kt.schema.enabled` - allows to disable the processor
- `kt.schema.include` - specify classes to include
- `kt.schema.exclude` - specify classes to exclude from processing
- `kt.schema.visibility` - specify visibility for generated extension properties

See [KSP Configuration Guide](https://github.com/kpavlov/kt-schema/blob/main/docs/ksp.md).
...
- Requires [`@Schema`][kt.schema.Schema] annotation
