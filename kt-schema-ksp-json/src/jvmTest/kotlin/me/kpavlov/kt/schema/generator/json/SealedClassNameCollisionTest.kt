        ...
        json.encodeToString(schema) shouldEqualJson
            $$"""
            {
              ...
              "$defs": {
                ...
                "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultA.Success": {
                  "type": "object",
                  "description": "Success result for A",
                  "properties": {
                    "type": { 
                      "type": "string", 
                       "const": "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultA.Success"
                    },
                    "value": {
                      "type": "string"
                    }
                ...
                "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultA.Unknown": {
                  "type": "object",
                  "description": "Unknown error for A",
                  "properties": {
                    "type": { "type": "string", "const": "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultA.Unknown" },
                    "code": {
                      "type": "integer"
                    }
                  },
                ...
                "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultB.Success": {
                  "type": "object",
                  "description": "Success result for B",
                  "properties": {
                    "type": { "type": "string", "const": "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultB.Success" },
                    "data": {
                      "type": "integer"
                    }
                  },
                ...
                "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultB.Unknown": {
                  "type": "object",
                  "description": "Unknown error for B",
                  "properties": {
                    "type": { "type": "string", "const": "me.kpavlov.kt.schema.generator.json.SealedClassNameCollisionTest.ResultB.Unknown" },
                    "message": {
                      "type": "string"
                    }
                  },
