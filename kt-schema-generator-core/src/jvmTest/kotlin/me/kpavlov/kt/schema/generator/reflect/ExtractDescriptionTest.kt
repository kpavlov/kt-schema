...
import me.kpavlov.kt.schema.generator.reflect.testfixtures.PackagePrivateAnnotationFixtures
...
class ExtractDescriptionTest {
     ...
     * `me.kpavlov.kt.schema.generator.reflect.testfixtures`. When [extractDescription] (in
     * `me.kpavlov.kt.schema.generator.reflect`) calls `KProperty1.get()` on its elements, the JVM
